...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250915131415_AddEndTimeCheckConstraint")]
    partial class AddEndTimeCheckConstraint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Models.TaskModel", b =>
                {
                    ...
                    b.ToTable("Tasks", t =>
                        {
                            t.HasCheckConstraint("CHK_DueDate_After_StartDate", "\"DueDate\" >= \"StartDate\"");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Models.TimeEntryModel", b =>
                {
                    ...
                    b.ToTable("TimeEntries", t =>
                        {
                            t.HasCheckConstraint("CHK_EndTime_After_StartTime", "\"EndTime\" >= \"StartTime\"");
                        });
                });
