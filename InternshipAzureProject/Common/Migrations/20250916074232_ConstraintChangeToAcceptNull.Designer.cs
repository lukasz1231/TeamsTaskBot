...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250916074232_ConstraintChangeToAcceptNull")]
    partial class ConstraintChangeToAcceptNull
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Models.TaskModel", b =>
                {
                    ...
                    b.ToTable("Tasks", t =>
                        {
                            t.HasCheckConstraint("CHK_DueDate_After_StartDate", "\"DueDate\" IS NULL OR \"DueDate\" > \"StartDate\"");
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Models.TimeEntryModel", b =>
                {
                    ...
                    b.ToTable("TimeEntries", t =>
                        {
                            t.HasCheckConstraint("CHK_EndTime_After_StartTime", "\"EndTime\" IS NULL OR \"EndTime\" >= \"StartTime\"");
                        });
                });
